...
public class DmClient implements Serializable {
	...
	public DmClient(final long id, final String firstName, final String lastName, final Date birthDate, final String phone) throws IncredibleBirthDateExc, EmptyPhoneNumberExc, PhoneNumberFormatExc  {
		this.id = id;
